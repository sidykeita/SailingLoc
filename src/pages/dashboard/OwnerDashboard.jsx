...
import moteur1 from '../../assets/images/moteur1.jpeg';
import cannesMoteur from '../../assets/images/cannes-moteur.jpeg';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="card p-6 md:col-span-2">
            <div className="flex justify-between items-center mb-4">
              ...
              <button 
onClick={() => {
                  console.log('=== DÉBUG BOUTON AJOUTER UN BATEAU ===');
                  console.log('1. Bouton cliqué');
                  console.log('2. navigate function:', typeof navigate);
                  console.log('3. Tentative de navigation vers /owner/add-boat');
                  
                  // Test simple d'abord
                  alert('Bouton cliqué ! Voir console pour plus de détails.');
                  
                  try {
                    navigate('/owner/add-boat');
                    console.log('4. Navigation réussie');
                  } catch (error) {
                    console.error('4. Erreur de navigation:', error);
            ...
            {loading ? (
              ...
              <div className="text-center py-8">
                ...
                <button 
                  onClick={() => {
                    console.log('Bouton Ajouter mon premier bateau cliqué');
                    console.log('Navigation vers /owner/add-boat');
                    navigate('/owner/add-boat');
                  }}
                  className="btn-primary"
                >
              ...
              <div className="space-y-4">
                {boats.map((boat) => (
                  <div key={boat.id} className="border rounded-lg p-4 flex flex-col md:flex-row">
                    <div className="w-full md:w-1/4 bg-neutral rounded-lg h-32 flex items-center justify-center mb-4 md:mb-0 md:mr-4 overflow-hidden">
                      {boat.imageUrl ? (
                        <img 
                          src={boat.imageUrl} 
                          alt={boat.name}
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            <button 
              onClick={() => {
                console.log('=== BOUTON ACTIONS RAPIDES - AJOUTER UN BATEAU ===');
                console.log('Navigation vers /owner/add-boat');
                navigate('/owner/add-boat');
              }}
            ...
            <button 
              onClick={() => {
                console.log('=== BOUTON ACTIONS RAPIDES - CALENDRIER ===');
                console.log('Navigation vers /owner/calendar');
            ...
            <button 
              onClick={() => {
                console.log('=== BOUTON ACTIONS RAPIDES - RÉSERVATIONS ===');
                console.log('Navigation vers /owner/reservations');
            ...
            <button 
              onClick={() => {
                console.log('=== BOUTON ACTIONS RAPIDES - REVENUS ===');
                console.log('Navigation vers /owner/revenus');
                navigate('/owner/revenus');
              }}
              className="card p-6 flex flex-col items-center justify-center hover:shadow-lg transition-shadow"
            >
              <svg className="w-12 h-12 text-primary mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
