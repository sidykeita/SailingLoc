    ...
    async function load() {
      try {
        ...
        const mapToCard = (r, direction = 'received') => {
          ...
          // Extraire l'owner: objet peuplé ou simple ID (r.owner ou boat.owner)
          ...
          return {
            ...
            owner: {
              id: ownerId,
              name: ownerObj.firstName ? `${ownerObj.firstName} ${ownerObj.lastName || ''}`.trim() : (ownerObj.name || 'Locataire'),
        ...
        // Avis reçus = réponses à mes avis (avec enrichissement)
