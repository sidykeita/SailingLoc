...
const CatamaranBoats = () => {
  ...
  useEffect(() => {
    setLoading(true);
    boatService
      .getAllBoats({ type: 'catamaran' })
      .then((data) => setBoats(Array.isArray(data) ? data : []))
      .catch(() => setError('Erreur lors du chargement des catamarans'))
  ...
  return (
    <div className="yacht-boats-page yacht-boats-container">{/* réutilisation des classes */}
      <div className="page-content container mx-auto px-4 py-8 content-container">
        <h1 className="text-3xl font-bold text-[#274991] mb-2">Location de catamarans</h1>
        <p className="text-[#333333] mb-8">Découvrez notre sélection de catamarans disponibles à la location</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {loading ? (
            <div className="col-span-3 text-center py-8">Chargement des catamarans...</div>
          ) : error ? (
            ...
            <div className="col-span-3 text-center py-8">
              ...
              <p className="text-gray-600">Aucun catamaran ne correspond à vos critères de recherche.</p>
              <button 
